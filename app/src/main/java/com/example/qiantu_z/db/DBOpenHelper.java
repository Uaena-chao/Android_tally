...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        insertType(db);
        //创建记账表
        sql = "create table accounttb(id integer primary key autoincrement,typename varchar(10),sImageId integer,beizhu varchar(100),money float," +
    ...
    private void insertType(SQLiteDatabase db) {
        ...
        db.execSQL(sql, new Object[]{"酒水饮料", R.mipmap.ic_yanjiu, R.mipmap.ic_yanjiu_fs, 0});
        ...
        db.execSQL(sql, new Object[]{"礼物", R.mipmap.ic_renqingwanglai, R.mipmap.ic_renqingwanglai_fs, 0});
